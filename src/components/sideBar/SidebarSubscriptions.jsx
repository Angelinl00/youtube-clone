...
function SidebarSubscriptions() {
  ...
  return (
    <li class="w-full h-auto flex flex-col justify-center pl-[24px] pr-[8px] py-[8px]">
      <span class="w-full h-[24px] flex flex-row text-white items-center">
        ...
        <img src="./images/unnamed.png" alt="" width="22" height="22" class="mr-[24px] rounded-full border-none" />
        <p>chaine youtube</p>
      </span>
    </li>
  )
